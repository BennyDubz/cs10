...
public class PaintedImage extends DrawingGUI {
	private static final int numBlobs = 60000;			// setup: how many blobs
	...
	private ArrayList<Wanderer> blobs;						// the blobs representing the picture
	...
	public void handleTimer() {
		for (int b = 0; b < numToMove; b++) {
			...
			Wanderer blob = blobs.get((int)(Math.random()*blobs.size()));
	...
	public static void main(String[] args) {
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				new PaintedImage(loadImage("assets/images/baker.jpeg"));
			}
		});
	}
}
